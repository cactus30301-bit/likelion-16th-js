...
// 작은따옴표로 문자열 생성
const 작은_따옴표 = '작은 따옴표'
// 따옴표 쌍이 일치하지 않을 경우 : ERROR Unterminated string literal
// 큰따옴표로 문자열 생성
const 큰_따옴표 = "큰 따옴표"
// 역따옴표로 문자열 생성
const 역_따옴표 = `역 따옴표`
...
// * +1 한계 초과 90071992547409912
// * +2 정확하지 않음 9007199254740991

// BigInt 생성 - 숫자 뒤에 n 붙이기
const bigIntLiteral = 1000n
console.log(bigIntLiteral)

// BigInt() 사용 : 숫자값 -> 빅인트(큰 정수) 변환
...
// 기능 사용 (실행, 호출)
console.log(커피_만들기('케냐', '뜨거운물', true))
