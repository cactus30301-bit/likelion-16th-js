...
// 데이터와 문자값을 연결할 때 문자값으로 변신시켜준다.


// 설명:
// 변수를 선언하고 값을 할당하지 않으면 JavaScript 엔진이 자동으로 undefined를 할당합니다. > 초기화
...
// 매개변수: name, age
// 기능: name과 age를 각각 출력
function greet (tempName, age) {
return 'tempName = ' + tempName + ' /age =' + age 
}
...
currentUser = null // 로그인 된 상태 -> 로그아웃
